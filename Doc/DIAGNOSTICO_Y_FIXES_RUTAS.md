...
router.post(
  "/request",
  requestController.upload.array("photos"),
...
// ==========================================
router.get(
  "/appointments/collector/:collectorId",
  appointmentController.getAppointmentsByCollector
);
router.get(
  "/appointments/recycler/:recyclerId",
  appointmentController.getAppointmentsByRecycler
);
```
